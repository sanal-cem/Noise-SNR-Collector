...
public class cGraphActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cellListenerActivity cla;
        cla = new cellListenerActivity();
        cla.scanCellData(this);
    ...
    private void refresh() {
        Intent i = new Intent(cGraphActivity.this, cGraphActivity.class);
        i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(i);
        finish();
    }
    ...
    private void setPageText() {
        ...
        SSIDTextView.setText("" + "Network: " + Global.operatorName + " - " + Global.networkType);
    ...
    private void generateData(DataPoint[] SNRpoints, DataPoint[] Signalpoints, DataPoint[] AvgSNRpoints) {
        ...
        for(int i=0; i < SNRlength; i++) {
            listenCell();
            Global.Moving_Avg_Signal = (Global.myNetwork_Signal + Global.Moving_Avg_Signal * i) / (i+1);
    ...
    private void listenCell(){
        cellListenerActivity cla = new cellListenerActivity();
        cla.scanCellData(this);
    }
