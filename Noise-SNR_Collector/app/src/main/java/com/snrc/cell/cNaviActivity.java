...
public class cNaviActivity extends AppCompatActivity
    ...
    private void gotoGraphActivity() {
        Intent i = new Intent(this, cGraphActivity.class);
        i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(i);
    }
    private void refresh() {
        Intent i = new Intent(cNaviActivity.this, cNaviActivity.class);
        i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(i);
        finish();
    }
    private void login() {
        ...
        new loginActivity(statusField).execute("CSNR");
    }
